  ...
  return (
    <section>
      <section className="container mx-auto px-6 py-12">
        <section className="bg-gradient-to-r from-blue-400 via-blue-500 to-indigo-600 p-8 rounded-3xl shadow-xl mb-12">
              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p><a href="tel:+507373-4907" className="text-blue-600">+507 788-6592</a></p> 
                  </div>
                </div>
                <div className="flex items-center">
                  <FaWhatsapp className="mr-4 text-3xl text-blue-500" />
                  <div>
                    <h4 className="font-medium text-lg">{t('whatsappTitle')}</h4>
                    <p><a href="https://wa.me/50768815949" className="text-blue-600">+507 6881-5949</a></p>
                   </div>
                </div>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p><a href="mailto:gerentecalidad@mp-ip.edu.pa" className="text-blue-600">sales@ttlogistic.com.pa</a></p>
                  </div>
                </div>
                <div className="flex items-center">
        ...
        {modalVisible && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-white text-black p-8 rounded-lg shadow-2xl max-w-sm mx-auto">
              ...
              <button onClick={() => setModalVisible(false)} className="w-full bg-blue-800 text-white py-3 rounded-lg mt-4 hover:bg-blue-800 transition">
                {t('close')}
              </button>
            </div>
          </div>
        ...
        {/* Social Media */}
        <section className="bg-gradient-to-r from-blue-800 via-blue-00 to-blue-500 text-white py-8 rounded-3xl shadow-xl mt-12">
          <h2 className="text-3xl font-bold text-center mb-8">{t('followUs')}</h2>
          <div className="flex justify-center gap-10">
            <a href="https://www.instagram.com/logistictravelstours/" className="hover:text-blue-500 transition"><FaInstagram size={40} /></a>
            <a href="https://www.facebook.com/logistictravelstours" className="hover:text-blue-500 transition"><FaFacebook size={40} /></a>
            ...
            <a href="https:/https://ttlogistic.com.pa/" className="hover:text-blue-500 transition"><TbWorldWww size={40} /></a>
          </div>
        </section>
      </section>
    </section>
